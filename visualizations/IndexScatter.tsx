...
// Scatter
function DrawIndexScatter(svgRef, data: [Killers], stereotypes) {
...
const IndexScatter: FunctionComponent = (props: Props) => {
  ...
  if (svgRef.current !== null && props.data !== null) DrawIndexScatter(svgRef, props.data, stereotypes /*currentStereotypes, stereotypes, setStereotype*/);

  return (<svg ref={svgRef} className={styles.chart}/>);
}
